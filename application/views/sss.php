...
<div id="formulario">
   ...
   <form name="form_mapa" method="POST" enctype="multipart/form-data">
  	 ...
  	 <input type="button" class="ui blue button" value="Direccion" onclick="codeAddress()">
		...
		<label>Lat</label>
		<input type="text" onchange="ejecuta()" name="latitud" id="lat" value="<?echo $latitud;?>" style="width: 100px;font-size: 10px;font-family: verdana;font-weight: bold;" />	    
	
		<label>Lon</label>
	   <input type="text" onchange="ejecuta()" name="longitud" id="lon" value="<?echo $longitud;?>" style="width: 100px;font-size: 10px;font-family: verdana;font-weight: bold;" />	
	  <input type="button" class="ui blue button" value="Lat y lon" onclick="codeLatLon()"> 
